...
import Banner from "../../assets/website/footer-pattern.jpeg";
import {
  FaFacebook,
  FaInstagram,
  FaLinkedin,
      ...
      <div className="container">
        ...
        className="grid md:grid-cols-3 pb-44 pt-5">
          ...
          <div className="py-8 px-4">
             ...
             <p>Lorem ipsum dolor sit amet consectetur adipisicing elit Quisquam fugiat cumque hic perspiciatis.</p>
          </div>
          {/*  footer Links  */}
